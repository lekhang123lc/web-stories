...
class Config {
  ...
  private $LimitPerPage =  15 ;

  // limit list in admin
  private $limitPerPage =  15 ;

  // limit in search
  private $limitCategories =  15;

  // limit categories in homepage
  private $limitPerCategory =  15;

  // limit stories per categories
  private $maxCategories =  100;

  // limit categories in sidebar
